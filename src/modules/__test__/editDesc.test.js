...
beforeAll(() => {
  ...
  <body data-new-gr-c-s-check-loaded="14.1055.0" data-gr-ext-installed="" data-new-gr-c-s-loaded="14.1055.0">
    <div id="todoDiv">
      ...
      <ul id="todoList">
        <li class="task"><input type="checkbox" name="0"><label for="0" contenteditable="false">Feed dogs</label>
          <div class="remove"><img src="https://retky.github.io/Mv-ToDoList/651605cb36c36cdda3f9.png" alt="remove"></div>
        </li>
      </ul>
      <div id="clear">
